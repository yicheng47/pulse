...
- **In flight**: nothing running; features 87 (DoP output label, `3c5804f` + `c403993`) and 84 (album artist link, `704178c`) merged 2026-09-04 and wait for the next release; feature 78 closed 2026-09-04 with stages 1, 2, and 4 shipped — its two untriggered items are feature 89; feature 76 seamless in-track transport (spec filed, mission queued behind 78); feature 77 manual device unlock (spec + Pencil pass in progress, design gate is Jason's).
...
| [Feature 84 — album page artist link](features/84-album-artist-link.md) | P2 | merged | Filed 2026-09-03 by Jason; merged 2026-09-04 as `704178c` (PR #92): the header's artist name opens the artist page through the existing Artists route, plain text when no artist row resolves. Ships in the next release; in-app look is Jason's. |
