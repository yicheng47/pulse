...
| [Feature 81 — Shared and Exclusive output modes](features/81-shared-exclusive-output-modes.md) | P2 | planned | Filed 2026-09-03 by Jason (#81): two ownership modes, Bit-perfect as the runtime verdict, stored Bit-perfect migrates to Exclusive. Sequenced with 78 stage 2 (same files); Pencil pass before phase 2. |
