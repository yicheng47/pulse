...
- **In flight**: feature 78 integer engine hardening — staged plan ([`impls/78-integer-engine-plan.md`](impls/78-integer-engine-plan.md)), stage 1 merged 2026-09-03 (`64d3bc5`, Jason's review), stage 2 landed inside feature 81 phase 2 (`995e426`), stages 3–4 next; feature 76 seamless in-track transport (spec filed, mission queued behind 78); feature 77 manual device unlock (spec + Pencil pass in progress, design gate is Jason's).
...
- **Up next**: feature 56 — now-playing page (design pinned, mission-ready); feature 78 stages 3–4 after each merge, stage 5 (mono sources) on Jason's decision.
...
| [Feature 78 — integer engine hardening](features/78-integer-engine-hardening.md) | P2 | in flight | Filed 2026-09-02 from the engine review: in-place format change at track boundaries, AUTO gate parity, stream-indexed IOProc fill. Staged 2026-09-03 as five PRs, Jason reviews each: [`impls/78-integer-engine-plan.md`](impls/78-integer-engine-plan.md); review record [`impls/78-integer-engine-review.md`](impls/78-integer-engine-review.md). Stage 1 merged 2026-09-03 (`64d3bc5`); stage 2 landed in feature 81 phase 2 (`995e426`, PR #82); Matrix acceptance of stages 1–2 is Jason's; stages 3–4 next. |
