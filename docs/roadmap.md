...
| [Feature 81 — Shared/Exclusive output modes](features/81-shared-exclusive-output-modes.md) | P2 | planned | Two user-facing modes; Exclusive resolves to the hardened integer backend when safe and AUHAL-exclusive otherwise; Bit-perfect stays a Signal Path verdict. Scheduled after 78; Pencil pass first. |
