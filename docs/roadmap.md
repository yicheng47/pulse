...
- **In flight**: feature 78 integer engine hardening — staged plan ([`impls/78-integer-engine-plan.md`](impls/78-integer-engine-plan.md)), stage 1 merged 2026-09-03 (`64d3bc5`, Jason's review), stage 2 landed inside feature 81 phase 2 (`995e426`), stages 3–4 next; feature 81 Shared/Exclusive output modes — phases 2–3 merged 2026-09-03 (`995e426`, `3e17bb2`) and the docs pass landed; Jason's visual check against the Pencil frames and the Matrix smoke pass close it; feature 76 seamless in-track transport (spec filed, mission queued behind 78); feature 77 manual device unlock (spec + Pencil pass in progress, design gate is Jason's).
...
| [Feature 81 — Shared/Exclusive output modes](features/81-shared-exclusive-output-modes.md) | P2 | in flight | Two user-facing modes; Exclusive resolves to the hardened integer backend when safe and AUHAL-exclusive otherwise; Bit-perfect stays a Signal Path verdict. Pencil pass approved by Jason 2026-09-03 (two neutral segments, lock glyph on Exclusive, no Auto affordance). Phase 2 (stored model, resolver, DoP gate on the confirmed engine kind; PR #82) merged 2026-09-03 as `995e426`; phase 3 (the approved surface: neutral segments, lock glyph on Exclusive, no Auto affordance; PR #83) merged 2026-09-03 as `3e17bb2`; phase 4 docs landed the same day. Remaining: Jason's visual pass against the Pencil frames and the Matrix smoke pass per the spec's Verification, then close #81 and archive the spec. |
