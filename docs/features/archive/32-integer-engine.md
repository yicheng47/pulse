...
- No DSD playback in this feature (the DoP test file is a verification payload here); DSD-over-DoP support is [feature 71](../71-dsd-over-dop.md), layered on this engine after the phase-4 acceptance pass.
